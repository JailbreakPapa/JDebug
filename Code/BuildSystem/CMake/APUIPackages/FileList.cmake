...
set(MASTER_Core_PUB_HDR_FILES
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core.h
)

set(Core_PUB_HDR_FILES
    ${PROJECT_SOURCE_DIR}/Include/APUI/Config/Config.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/Animation.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/BaseXMLParser.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/Box.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/Colour.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/Colour.inl
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/ComputedValues.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/Containers/itlib/flat_map.hpp
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/Containers/itlib/flat_set.hpp
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/Containers/robin_hood.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/Context.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/ContextInstancer.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/ConvolutionFilter.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/Core.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/DataModelHandle.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/DataStructHandle.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/DataTypeRegister.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/DataTypes.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/DataVariable.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/Debug.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/Decorator.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/DecoratorInstancer.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/Dictionary.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/Element.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/Element.inl
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/ElementDocument.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/ElementInstancer.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/Elements/ElementForm.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/Elements/ElementFormControl.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/Elements/ElementFormControlInput.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/Elements/ElementFormControlSelect.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/Elements/ElementFormControlTextArea.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/Elements/ElementProgress.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/Elements/ElementTabSet.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/ElementScroll.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/ElementText.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/ElementUtilities.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/Event.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/EventInstancer.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/EventListener.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/EventListenerInstancer.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/Factory.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/FileInterface.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/FontEffect.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/FontEffectInstancer.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/FontEngineInterface.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/FontGlyph.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/FontMetrics.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/Geometry.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/GeometryUtilities.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/Header.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/ID.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/Input.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/Log.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/Math.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/Matrix4.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/Matrix4.inl
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/NumericValue.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/ObserverPtr.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/Platform.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/Plugin.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/Profiling.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/PropertiesIteratorView.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/Property.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/PropertyDefinition.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/PropertyDictionary.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/PropertyIdSet.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/PropertyParser.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/PropertySpecification.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/Rectangle.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/RenderInterface.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/ScriptInterface.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/ScrollTypes.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/Spritesheet.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/Stream.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/StreamMemory.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/StringUtilities.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/StyleSheet.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/StyleSheetContainer.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/StyleSheetSpecification.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/StyleSheetTypes.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/StyleTypes.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/SystemInterface.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/Texture.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/TextShapingContext.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/Traits.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/Transform.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/TransformPrimitive.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/Tween.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/TypeConverter.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/TypeConverter.inl
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/Types.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/Unit.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/URL.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/Utilities.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/Variant.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/Variant.inl
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/Vector2.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/Vector2.inl
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/Vector3.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/Vector3.inl
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/Vector4.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/Vector4.inl
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/Vertex.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/XMLNodeHandler.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Core/XMLParser.h
)
...
set(MASTER_Debugger_PUB_HDR_FILES
    ${PROJECT_SOURCE_DIR}/Include/APUI/Debugger.h
)

set(Debugger_PUB_HDR_FILES
    ${PROJECT_SOURCE_DIR}/Include/APUI/Debugger/Debugger.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Debugger/Header.h
)
...
set(Lua_HDR_FILES
    ...
    ${PROJECT_SOURCE_DIR}/Source/Lua/APUI.h
    ${PROJECT_SOURCE_DIR}/Source/Lua/APUIContextsProxy.h
    ${PROJECT_SOURCE_DIR}/Source/Lua/Vector2f.h
    ${PROJECT_SOURCE_DIR}/Source/Lua/Vector2i.h
)

set(Lua_PUB_HDR_FILES
    ${PROJECT_SOURCE_DIR}/Include/APUI/Lua/Header.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Lua/IncludeLua.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Lua/Interpreter.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Lua/Lua.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Lua/LuaType.h
    ${PROJECT_SOURCE_DIR}/Include/APUI/Lua/Utilities.h
)
...
set(Lua_SRC_FILES
    ...
    ${PROJECT_SOURCE_DIR}/Source/Lua/APUI.cpp
    ${PROJECT_SOURCE_DIR}/Source/Lua/APUIContextsProxy.cpp
...
set(Lottie_PUB_HDR_FILES
    ${PROJECT_SOURCE_DIR}/Include/APUI/Lottie/ElementLottie.h
)
...
set(SVG_PUB_HDR_FILES
    ${PROJECT_SOURCE_DIR}/Include/APUI/SVG/ElementSVG.h
)
