# #####################################
# ## ns_list_subdirs(result curdir)
# #####################################

macro(ns_list_subdirs result curdir)
...
# #####################################
# ## ns_android_add_default_content(<target>)
# #####################################
function(ns_android_add_default_content TARGET_NAME)
	ns_pull_all_vars()

	if(NOT NS_CMAKE_PLATFORM_ANDROID)
		return()
	endif()
	...
	set(CONTENT_DIRECTORY_SRC "${NS_ROOT}/Data/Platform/Android")
	...
	ns_list_subdirs(AVAILABLE_BUILD_TOOLS ${ANDROID_BUILD_TOOLS_ROOT})
