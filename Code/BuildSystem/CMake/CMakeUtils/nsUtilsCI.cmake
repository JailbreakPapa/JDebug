# #####################################
# ## ns_ci_add_to_targets_list(<target> [C++])
# #####################################

function(ns_ci_add_to_targets_list TARGET_NAME LANGUAGE)
	if(NS_NO_TXT_FILES)
		return()
	endif()
...
# #####################################
# ## ns_ci_add_test(<target> [NEEDS_HW_ACCESS])
# #####################################
function(ns_ci_add_test TARGET_NAME)
	...
	if(ARG_UNPARSED_ARGUMENTS)
		message(FATAL_ERROR "ns_ci_add_test: Invalid arguments '${ARG_UNPARSED_ARGUMENTS}'")
	endif()
