...
function(ns_add_as_runtime_dependency TARGET_NAME)
	...
	# samples
	ns_add_dependency(Asteroids ${TARGET_NAME})
	ns_add_dependency(ComputeShaderHistogram ${TARGET_NAME})
	ns_add_dependency(RtsGamePlugin ${TARGET_NAME})
	ns_add_dependency(SampleGamePlugin ${TARGET_NAME})
	ns_add_dependency(ShaderExplorer ${TARGET_NAME})
	ns_add_dependency(TextureSample ${TARGET_NAME})
endfunction()