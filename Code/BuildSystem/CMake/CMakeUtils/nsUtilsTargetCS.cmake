# #####################################
# ## ns_create_target_cs(<LIBRARY | APPLICATION> <target-name>)
# #####################################

macro(ns_create_target_cs TYPE TARGET_NAME)
	ns_apply_build_filter(${TARGET_NAME})

	set(ARG_OPTIONS NO_NS_PREFIX)
	...
	if(ARG_UNPARSED_ARGUMENTS)
		message(FATAL_ERROR "ns_create_target_cs: Invalid arguments '${ARG_UNPARSED_ARGUMENTS}'")
	endif()
	...
	elseif(${TYPE} STREQUAL "APPLICATION")
		...
		message(FATAL_ERROR "ns_create_target_cs: Missing argument to specify target type. Pass in 'APPLICATION' or 'SHARED_LIBRARY' or 'STATIC_LIBRARY'.")
	endif()
	...
	# use ns_make_winmain_executable if this is desired
