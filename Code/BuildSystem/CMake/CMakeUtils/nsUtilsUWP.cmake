# #####################################
# ## ns_uwp_mark_import_as_content(<import>)
# #####################################
...
function(ns_uwp_mark_import_as_content IMPORT)
	...
	get_target_property(_dll_location_debug ${IMPORT} IMPORTED_LOCATION_${NS_BUILDTYPENAME_DEBUG_UPPER})
	...
	if(${_dll_location_debug} STREQUAL ${_dll_location})
		...
		set_property(SOURCE ${_dll_location_debug} PROPERTY VS_DEPLOYMENT_CONTENT $<CONFIG:${NS_BUILDTYPENAME_DEBUG}>)

		set_property(SOURCE ${_dll_location} PROPERTY VS_DEPLOYMENT_CONTENT $<OR:$<CONFIG:${NS_BUILDTYPENAME_RELEASE}>,$<CONFIG:${NS_BUILDTYPENAME_DEV}>>)
...
function(ns_uwp_add_import_to_sources TARGET_NAME IMPORT)
	...
	get_target_property(_dll_location ${IMPORT} IMPORTED_LOCATION_${NS_BUILDTYPENAME_DEBUG_UPPER})
	target_sources(${TARGET_NAME} PUBLIC ${_dll_location})

	get_target_property(_dll_location ${IMPORT} IMPORTED_LOCATION_${NS_BUILDTYPENAME_DEV_UPPER})
	target_sources(${TARGET_NAME} PUBLIC ${_dll_location})

	get_target_property(_dll_location ${IMPORT} IMPORTED_LOCATION_${NS_BUILDTYPENAME_RELEASE_UPPER})
	target_sources(${TARGET_NAME} PUBLIC ${_dll_location})
...
function(ns_uwp_add_default_content TARGET_NAME)
	...
	set(CONTENT_DIRECTORY_SRC "${NS_ROOT}/Data/Platform/UWP/")
	...
	string(UUID PACKAGE_GUID NAMESPACE ${PACKAGE_GUID} NAME "nsEngine" TYPE MD5) # Generate GUID
