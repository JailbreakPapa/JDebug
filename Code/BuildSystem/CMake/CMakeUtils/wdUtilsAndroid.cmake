# #####################################
# ## wd_list_subdirs(result curdir)
# #####################################

macro(wd_list_subdirs result curdir)
...
# #####################################
# ## wd_android_add_default_content(<target>)
# #####################################
function(wd_android_add_default_content TARGET_NAME)
	wd_pull_all_vars()

	if(NOT WD_CMAKE_PLATFORM_ANDROID)
		return()
	endif()
	...
	set(CONTENT_DIRECTORY_SRC "${CMAKE_SOURCE_DIR}/${WD_SUBMODULE_PREFIX_PATH}/Data/Platform/Android")
	...
	wd_list_subdirs(AVAILABLE_BUILD_TOOLS ${ANDROID_BUILD_TOOLS_ROOT})
