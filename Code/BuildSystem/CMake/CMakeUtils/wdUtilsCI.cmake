# #####################################
# ## wd_ci_add_to_targets_list(<target> [C++])
# #####################################

function(wd_ci_add_to_targets_list TARGET_NAME LANGUAGE)
...
# #####################################
# ## wd_ci_add_test(<target> [NEEDS_HW_ACCESS])
# #####################################
function(wd_ci_add_test TARGET_NAME)
	...
	if(ARG_UNPARSED_ARGUMENTS)
		message(FATAL_ERROR "wd_ci_add_test: Invalid arguments '${ARG_UNPARSED_ARGUMENTS}'")
	endif()
