...
class NS_CORE_DLL nsCommandInterpreterLua : public nsCommandInterpreter
{
public:
  /// \brief The default interpreter used by nsConsole. Uses Lua for parsing and execution.
  ///
  /// The Lua interpreter can modify nsCVar variables and call nsConsoleFunction functions.
  ///
  ...
  ///
  /// If there is any kind of error (e.g. a Lua syntax error), the interpreter will return NS_FAILURE;
