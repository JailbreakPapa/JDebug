...
public:
  ...
  void SetControllerMapping(nsUInt8 uiVirtualController, nsInt8 iTakeInputFromPhysical);
  ...
  nsInt8 GetControllerMapping(nsUInt8 uiVirtual) const;

  /// \brief Queries whether the controller with the given physical index is connected to the computer.
  /// This may change at any time.
  virtual bool IsControllerConnected(nsUInt8 uiPhysical) const = 0;
