...
/// \brief Part of the zip / apk support of the nsArchiveReader.
...
/// \brief A stream reader that will decompress data that was stored using the nsCompressedStreamWriterZlib.
///
