...
///
/// wdRational uses the following rules
...
public:
  ...
  wdRational ReduceIntegralFraction() const;

protected:
  wdUInt32 m_uiNumerator = 0;
  wdUInt32 m_uiDenominator = 1;
};
