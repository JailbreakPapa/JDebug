...
// clang-format off
NS_BEGIN_SUBSYSTEM_DECLARATION(InspectorPlugin, InspectorPluginMain)
  ...
  ON_CORESYSTEMS_SHUTDOWN
  {
    ...
    nsTelemetry::AcceptMessagesForSystem(' APP', false);
  }

NS_END_SUBSYSTEM_DECLARATION;
// clang-format on

NS_STATICLINK_FILE(InspectorPlugin, InspectorPlugin_Main);
