...
// clang-format off
const nsUInt8 nsGALResourceFormat::s_BitsPerElement[nsGALResourceFormat::ENUM_COUNT] =
{
  0, // Invalid
...
const nsUInt8 nsGALResourceFormat::s_ChannelCount[nsGALResourceFormat::ENUM_COUNT] =
{
  0, // Invalid
