...
static vk::CullModeFlagBits GALCullModeToVulkan[nsGALCullMode::ENUM_COUNT] =
  {
    vk::CullModeFlagBits::eNone,
    vk::CullModeFlagBits::eFront,
    vk::CullModeFlagBits::eBack};

static const vk::SamplerAddressMode GALTextureAddressModeToVulkan[nsImageAddressMode::ENUM_COUNT] =
  {
...
static const vk::CompareOp GALCompareFuncToVulkan[nsGALCompareFunc::ENUM_COUNT] =
  {
    vk::CompareOp::eNever,
    vk::CompareOp::eLess,
    vk::CompareOp::eEqual,
