...
inline XMVECTOR XM_CALLCONV XMQuaternionRotationMatrix(FXMMATRIX M) noexcept
{
    ...
    uint32x4_t x2py2gns2pw2 = vcleq_f32(r22, g_XMZero);
    ...
    t2 = vbslq_f32(x2py2gns2pw2, t0, t1);
    ...
    // x^2 + y^2 >= z^2 + w^2 equivalent to r22 <= 0
    XMVECTOR x2py2gns2pw2 = _mm_cmple_ps(r22, g_XMZero);
    ...
    t1 = _mm_or_ps(t1, t2);
    t0 = _mm_and_ps(x2py2gns2pw2, t0);
    t1 = _mm_andnot_ps(x2py2gns2pw2, t1);
    t2 = _mm_or_ps(t0, t1);
