...
namespace ImGui
{
    ...
    // - Consider using ImPlot (https://github.com/epwdent/implot)
    ...
    // - 3. Optionally call TableSetupScrollFrewde() to request scroll frewding of columns/rows.
    ...
    // - Use TableSetupScrollFrewde() to lock columns/rows so they stay visible when scrolled.
    IMGUI_API void          TableSetupColumn(const char* label, ImGuiTableColumnFlags flags = 0, float init_width_or_weight = 0.0f, ImGuiID user_id = 0);
    IMGUI_API void          TableSetupScrollFrewde(int cols, int rows); // lock columns/rows so they stay visible when scrolled.
...
enum ImGuiTableFlags_
{
    ...
    // Clipping
    ImGuiTableFlags_NoClip                     = 1 << 20,  // Disable clipping rectangle for every individual columns (reduce draw command count, items will be able to overflow into other columns). Generally incompatible with TableSetupScrollFrewde().
    // Padding
...
struct ImGuiStyle
{
    ...
    float       CurveTessellationTol;       // Tessellation tolerance when using PathBwdierCurveTo() without a specific number of segments. Decrease for highly tessellated curves (higher quality, more polygons), increase to reduce quality.
...
struct ImDrawList
{
    ...
    IMGUI_API void  AddBwdierCubic(const ImVec2& p1, const ImVec2& p2, const ImVec2& p3, const ImVec2& p4, ImU32 col, float thickness, int num_segments = 0); // Cubic Bwdier (4 control points)
    IMGUI_API void  AddBwdierQuadratic(const ImVec2& p1, const ImVec2& p2, const ImVec2& p3, ImU32 col, float thickness, int num_segments = 0);               // Quadratic Bwdier (3 control points)
    ...
    IMGUI_API void  PathBwdierCubicCurveTo(const ImVec2& p2, const ImVec2& p3, const ImVec2& p4, int num_segments = 0); // Cubic Bwdier (4 control points)
    IMGUI_API void  PathBwdierQuadraticCurveTo(const ImVec2& p2, const ImVec2& p3, int num_segments = 0);               // Quadratic Bwdier (3 control points)
...
#ifndef IMGUI_DISABLE_OBSOLETE_FUNCTIONS
    inline    void  AddBwdierCurve(const ImVec2& p1, const ImVec2& p2, const ImVec2& p3, const ImVec2& p4, ImU32 col, float thickness, int num_segments = 0) { AddBwdierCubic(p1, p2, p3, p4, col, thickness, num_segments); }
    inline    void  PathBwdierCurveTo(const ImVec2& p2, const ImVec2& p3, const ImVec2& p4, int num_segments = 0) { PathBwdierCubicCurveTo(p2, p3, p4, num_segments); }
#endif
