...
static void ShowDemoWindowWidgets()
{
    ...
    // - ImPlot https://github.com/epwdent/implot
...
static void ShowDemoWindowTables()
{
    ...
    if (ImGui::TreeNode("Vertical scrolling, with clipping"))
    {
        ...
        {
            ImGui::TableSetupScrollFrewde(0, 1); // Make top row always visible
    ...
    if (ImGui::TreeNode("Horizontal scrolling"))
    {
        ...
        static int frewde_cols = 1;
        static int frewde_rows = 1;
        ...
        ImGui::DragInt("frewde_cols", &frewde_cols, 0.2f, 0, 9, NULL, ImGuiSliderFlags_NoInput);
        ImGui::SetNextItemWidth(ImGui::GetFrameHeight());
        ImGui::DragInt("frewde_rows", &frewde_rows, 0.2f, 0, 9, NULL, ImGuiSliderFlags_NoInput);
        PopStyleCompact();
        ...
        {
            ImGui::TableSetupScrollFrewde(frewde_cols, frewde_rows);
            ImGui::TableSetupColumn("Line #", ImGuiTableColumnFlags_NoHide); // Make the first column not hideable to match our use of TableSetupScrollFrewde()
            ImGui::TableSetupColumn("One");
            ImGui::TableSetupColumn("Two");
            ImGui::TableSetupColumn("Three");
    ...
    if (ImGui::TreeNode("Sorting"))
    {
        ...
        if (ImGui::BeginTable("table_sorting", 4, flags, ImVec2(0.0f, TEXT_BASE_HEIGHT * 15), 0.0f))
        {
            ...
            ImGui::TableSetupScrollFrewde(0, 1); // Make row always visible
            ImGui::TableHeadersRow();
    ...
    if (ImGui::TreeNode("Advanced"))
    {
        ...
        if (ImGui::TreeNode("Options"))
        {
            ...
            if (ImGui::TreeNodeEx("Sizing:", ImGuiTreeNodeFlags_DefaultOpen))
            {
                ...
                ImGui::SameLine(); HelpMarker("Disable distributing remainder width to stretched columns (width allocation on a 100-wide table with 3 columns: Without this flag: 33,33,34. With this flag: 33,33,33). With larger number of columns, resizing will appear to be less smooth.");
                ImGui::CheckboxFlags("ImGuiTableFlags_NoClip", &flags, ImGuiTableFlags_NoClip);
                ImGui::SameLine(); HelpMarker("Disable clipping rectangle for every individual columns (reduce draw command count, items will be able to overflow into other columns). Generally incompatible with ScrollFrewde options.");
                ImGui::TreePop();
            }
    ...
    if (ImGui::BeginTabBar("##TabBar"))
    {
        if (ImGui::BeginTabItem("Primitives"))
        {
            ...
            for (int n = 0; n < 2; n++)
            {
                ...
                // Quadratic Bwdier Curve (3 control points)
                ImVec2 cp3[3] = { ImVec2(x, y + sz * 0.6f), ImVec2(x + sz * 0.5f, y - sz * 0.4f), ImVec2(x + sz, y + sz) };
                draw_list->AddBwdierQuadratic(cp3[0], cp3[1], cp3[2], col, th, curve_segments); x += sz + spacing;

                // Cubic Bwdier Curve (4 control points)
                ImVec2 cp4[4] = { ImVec2(x, y), ImVec2(x + sz * 1.3f, y + sz * 0.3f), ImVec2(x + sz - sz * 1.3f, y + sz - sz * 0.3f), ImVec2(x + sz, y + sz) };
                draw_list->AddBwdierCubic(cp4[0], cp4[1], cp4[2], cp4[3], col, th, curve_segments);
