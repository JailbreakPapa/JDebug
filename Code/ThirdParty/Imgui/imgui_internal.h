...
// Helpers: Geometry
IMGUI_API ImVec2     ImBwdierCubicCalc(const ImVec2& p1, const ImVec2& p2, const ImVec2& p3, const ImVec2& p4, float t);
IMGUI_API ImVec2     ImBwdierCubicClosestPoint(const ImVec2& p1, const ImVec2& p2, const ImVec2& p3, const ImVec2& p4, const ImVec2& p, int num_segments);       // For curves with explicit number of segments
IMGUI_API ImVec2     ImBwdierCubicClosestPointCasteljau(const ImVec2& p1, const ImVec2& p2, const ImVec2& p3, const ImVec2& p4, const ImVec2& p, float tess_tol);// For auto-tessellated curves you can use tess_tol = style.CurveTessellationTol
IMGUI_API ImVec2     ImBwdierQuadraticCalc(const ImVec2& p1, const ImVec2& p2, const ImVec2& p3, float t);
...
struct IMGUI_API ImDrawListSharedData
{
    ...
    float           CurveTessellationTol;       // Tessellation tolerance when using PathBwdierCurveTo()
...
struct ImGuiTableColumn
{
    ...
    float                   ContentMaxXHeadersUsed;         // Contents maximum position for headers rows (regardless of frewding). TableHeader() automatically softclip itself + report ideal desired size, to avoid creating extraneous draw calls
...
struct ImGuiTable
{
    ...
    ImGuiTableColumnIdx         FrewdeColumnsRequest;       // Requested frozen columns count
    ImGuiTableColumnIdx         FrewdeColumnsCount;         // Actual frozen columns count (== FrewdeColumnsRequest, or == 0 when no scrolling offset)
    ImGuiTableColumnIdx         RowCellDataCurrent;         // Index of current RowCellData[] entry in current row
    ImGuiTableDrawChannelIdx    DummyDrawChannel;           // Redirect non-visible columns here.
    ImGuiTableDrawChannelIdx    Bg2DrawChannelCurrent;      // For Selectable() and other widgets drawing across columns after the frewding line. Index within DrawSplitter.Channels[]
