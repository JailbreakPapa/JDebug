if(TARGET glfw)
    ns_set_build_flags(glfw)
    ns_set_default_target_output_dirs(glfw)
    ...
    ns_set_project_ide_folder(glfw "Code/ThirdParty/GLFW")
    ns_set_project_ide_folder(update_mappings "Code/ThirdParty/GLFW")
