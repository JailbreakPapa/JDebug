...
class WD_GUIFOUNDATION_DLL wdQtCollapsibleGroupBox : public wdQtGroupBoxBase, protected Ui_CollapsibleGroupBox
{
  Q_OBJECT
public:
  explicit wdQtCollapsibleGroupBox(QWidget* pParent);
