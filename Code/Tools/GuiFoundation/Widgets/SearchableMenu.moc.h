...
class wdQtTreeSearchFilterModel;
...
class WD_GUIFOUNDATION_DLL wdQtSearchableMenu : public QWidgetAction
{
  Q_OBJECT
public:
  /// \brief The parent should usually be a QMenu into which this QWidgetAction is inserted as an action.
  wdQtSearchableMenu(QObject* pParent);
...
private:
  ...
  QWidget* m_pGroup;
  wdQtSearchWidget* m_pSearch;
  wdQtTreeSearchFilterModel* m_pFilterModel;
  QTreeView* m_pTreeView;
  QStandardItemModel* m_pItemModel;
  wdMap<wdString, QStandardItem*> m_Hierarchy;
};
