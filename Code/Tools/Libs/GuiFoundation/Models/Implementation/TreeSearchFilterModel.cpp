...
nsQtTreeSearchFilterModel::nsQtTreeSearchFilterModel(QWidget* pParent)
  : QSortFilterProxyModel(pParent)
{
  m_bIncludeChildren = false;
}

void nsQtTreeSearchFilterModel::SetFilterText(const QString& sText)
{
...
void nsQtTreeSearchFilterModel::SetIncludeChildren(bool bInclude)
{
...
void nsQtTreeSearchFilterModel::RecomputeVisibleItems()
{
...
bool nsQtTreeSearchFilterModel::UpdateVisibility(const QModelIndex& idx, bool bParentIsVisible)
{
  bool bExisted = false;
...
bool nsQtTreeSearchFilterModel::filterAcceptsRow(int source_row, const QModelIndex& source_parent) const
{
