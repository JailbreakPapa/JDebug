...
//	The shader compiler will take the defined name: NORTHSTAR_ENGINE_DEFAULT_ROOTSIGNATURE and use it as root signature
//	If you wish to specify custom root signature, make sure that this define is not available
//		(for example: not including this file, or using #undef NORTHSTAR_ENGINE_DEFAULT_ROOTSIGNATURE)
#define NORTHSTAR_ENGINE_DEFAULT_ROOTSIGNATURE \
