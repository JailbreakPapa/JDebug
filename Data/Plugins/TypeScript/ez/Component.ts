...
export abstract class Component {
    ...
    /**
     * Sends an wd.Message directly to this component.
     * 
    ...
    /**
     * Sends and wd.Message to this component.
...
export abstract class TypescriptComponent extends Component {
     ...
     * 
     * @param msgType The TS type of the message to handle. E.g. 'wd.MsgSetColor'
