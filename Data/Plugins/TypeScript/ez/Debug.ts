...
export namespace Debug {
    ...
    export enum ArgType { // see wdVariant::Type for values
        Boolean = 2,
        Number = 12,
        String = 27,
    }
     ...
     * @param argTypes Variadic list describing the type of each argument. E.g. "wd.Debug.ArgType.String, wd.Debug.ArgType.Number"
     */
