...
/**
 * Represents a C++ wdGameObject on the TypeScript side.
 * 
 ...
 * the C++ side wdGameObject has been deleted and the TypeScript instance cannot be used anymore either.
 * 
...
export class GameObject {
     ...
     * 
     * See also wd.Utils.FindPrefabRootScript() for the common use case to finding the script of a prefab instance.
     * 
