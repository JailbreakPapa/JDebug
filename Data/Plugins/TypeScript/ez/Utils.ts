...
export namespace Utils {
     ...
     * say it is called 'prefab-proxy'. This node typically holds a single wdPrefabReferenceComponent. After prefab instantiation is complete,
    ...
    /**
     * Similar to wd.Utils.FindPrefabRootNode() but additionally searches for a specific script component.
     * 
