...
export namespace World {
   ...
   * 
   * Example:
   *   let slider = wd.World.CreateComponent(someGameObject, wd.SliderComponent);
   * 
   ...
   * 
   * @param type The object type category to search for. See wdMarkerComponent for a way to attach a type category to an object.
