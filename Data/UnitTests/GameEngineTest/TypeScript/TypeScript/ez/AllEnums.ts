...
export enum UpdateRate {  EveryFrame = 0, Max30fps = 1, Max20fps = 2, Max10fps = 3, Max5fps = 4, Max2fps = 5, Max1fps = 6 }
export enum WindStrength {  Calm = 0, LightBrewde = 1, GentleBrewde = 2, ModerateBrewde = 3, StrongBrewde = 4, Storm = 5, WeakShockwave = 6, MediumShockwave = 7, StrongShockwave = 8, ExtremeShockwave = 9 }
