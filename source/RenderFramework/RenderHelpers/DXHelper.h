...
// Used for naming D3D12 Objects that inherit from: ID3D12Object.
#define D3D12_NAME_OBJECT(c, s) (SetDebugN(c, s))
// Used for naming D3D12 Objects that inherit from: ID3D12Pageable.
#define D3D12_NAME_OBJECT_PAGEABLE(a, b) (SetDebugPageable(a, b))
// Used for releasing COM(D3D12) Objects.
#define RELEASE_COM(a) (ReleaseComD3D12(a))
// Used for releasing DXGI(COM) Objects.
#define RELEASE_COM_DXGI(b) (ReleaseComDXGI(b))
// Used for releasing IUnknown(COM) Objects.
#define RELEASE_COM_IU(c)
...
//------------------------------------------------------------------------------------------------
inline bool operator==(const D3D12_VIEWPORT& l,
                       const D3D12_VIEWPORT& r) noexcept {
  ...
  explicit CD3DX12_VIEWPORT(_In_ ID3D12Resource* pResource, UINT mipSlice = 0,
    ...
    switch (Desc.Dimension) {
      ...
      case D3D12_RESOURCE_DIMENSION_TEXTURE1D:
        ...
        TopLeftY = 0.0f;
        Width =
            (SubresourceWidth ? static_cast<float>(SubresourceWidth) : 1.0f) -
            topLeftX;
        Height = 1.0f;
        break;
      ...
      case D3D12_RESOURCE_DIMENSION_TEXTURE3D:
        ...
        Width =
            ...
            topLeftX;
        Height =
            (SubresourceHeight ? static_cast<float>(SubresourceHeight) : 1.0f) -
            topLeftY;
        break;
      default:
        break;
...
struct CD3DX12_DEPTH_STENCIL_DESC : public D3D12_DEPTH_STENCIL_DESC {
  ...
  explicit CD3DX12_DEPTH_STENCIL_DESC(
      const D3D12_DEPTH_STENCIL_DESC& o) noexcept
...
struct CD3DX12_DEPTH_STENCIL_DESC1 : public D3D12_DEPTH_STENCIL_DESC1 {
  ...
  explicit CD3DX12_DEPTH_STENCIL_DESC1(
      const D3D12_DEPTH_STENCIL_DESC1& o) noexcept
...
struct CD3DX12_RESOURCE_ALLOCATION_INFO
  ...
  explicit CD3DX12_RESOURCE_ALLOCATION_INFO(
      const D3D12_RESOURCE_ALLOCATION_INFO& o) noexcept
...
inline bool operator==(const D3D12_HEAP_PROPERTIES& l,
                       const D3D12_HEAP_PROPERTIES& r) noexcept {
...
inline bool operator==(const D3D12_HEAP_DESC& l,
                       const D3D12_HEAP_DESC& r) noexcept {
...
struct CD3DX12_SUBRESOURCE_RANGE_UINT64
  ...
  explicit CD3DX12_SUBRESOURCE_RANGE_UINT64(
      const D3D12_SUBRESOURCE_RANGE_UINT64& o) noexcept
...
struct CD3DX12_TILED_RESOURCE_COORDINATE
  ...
  explicit CD3DX12_TILED_RESOURCE_COORDINATE(
      const D3D12_TILED_RESOURCE_COORDINATE& o) noexcept
...
struct CD3DX12_SUBRESOURCE_TILING : public D3D12_SUBRESOURCE_TILING {
  ...
  explicit CD3DX12_SUBRESOURCE_TILING(
      const D3D12_SUBRESOURCE_TILING& o) noexcept
...
struct CD3DX12_RESOURCE_BARRIER : public D3D12_RESOURCE_BARRIER {
  ...
  static CD3DX12_RESOURCE_BARRIER UAV(_In_ ID3D12Resource* pResource) noexcept {
    CD3DX12_RESOURCE_BARRIER result = {};
    D3D12_RESOURCE_BARRIER& barrier = result;
...
struct CD3DX12_SUBRESOURCE_FOOTPRINT : public D3D12_SUBRESOURCE_FOOTPRINT {
  ...
  explicit CD3DX12_SUBRESOURCE_FOOTPRINT(
      const D3D12_SUBRESOURCE_FOOTPRINT& o) noexcept
...
struct CD3DX12_TEXTURE_COPY_LOCATION : public D3D12_TEXTURE_COPY_LOCATION {
  ...
  explicit CD3DX12_TEXTURE_COPY_LOCATION(
      const D3D12_TEXTURE_COPY_LOCATION& o) noexcept
...
struct CD3DX12_DESCRIPTOR_RANGE : public D3D12_DESCRIPTOR_RANGE {
  ...
  void Init(D3D12_DESCRIPTOR_RANGE_TYPE rangeType, UINT numDescriptors,
  ...
  static void Init(_Out_ D3D12_DESCRIPTOR_RANGE& range,
...
struct CD3DX12_ROOT_DESCRIPTOR_TABLE : public D3D12_ROOT_DESCRIPTOR_TABLE {
  ...
  explicit CD3DX12_ROOT_DESCRIPTOR_TABLE(
      const D3D12_ROOT_DESCRIPTOR_TABLE& o) noexcept
  ...
  void Init(UINT numDescriptorRanges,
            _In_reads_opt_(numDescriptorRanges)
...
struct CD3DX12_ROOT_CONSTANTS : public D3D12_ROOT_CONSTANTS {
  ...
  void Init(UINT num32BitValues, UINT shaderRegister,
            UINT registerSpace = 0) noexcept {
    Init(*this, num32BitValues, shaderRegister, registerSpace);
  }

  static void Init(_Out_ D3D12_ROOT_CONSTANTS& rootConstants,
...
struct CD3DX12_ROOT_DESCRIPTOR : public D3D12_ROOT_DESCRIPTOR {
  ...
  static void Init(_Out_ D3D12_ROOT_DESCRIPTOR& table, UINT shaderRegister,
                   UINT registerSpace = 0) noexcept {
...
struct CD3DX12_ROOT_PARAMETER : public D3D12_ROOT_PARAMETER {
  ...
  static void InitAsConstants(_Out_ D3D12_ROOT_PARAMETER& rootParam,
                              UINT num32BitValues, UINT shaderRegister,
                              UINT registerSpace = 0,
                              D3D12_SHADER_VISIBILITY visibility =
                                  D3D12_SHADER_VISIBILITY_ALL) noexcept {
...
struct CD3DX12_STATIC_SAMPLER_DESC : public D3D12_STATIC_SAMPLER_DESC {
  ...
  explicit CD3DX12_STATIC_SAMPLER_DESC(
      const D3D12_STATIC_SAMPLER_DESC& o) noexcept
  ...
  static void Init(
      _Out_ D3D12_STATIC_SAMPLER_DESC& samplerDesc, UINT shaderRegister,
...
struct CD3DX12_ROOT_SIGNATURE_DESC : public D3D12_ROOT_SIGNATURE_DESC {
  ...
  explicit CD3DX12_ROOT_SIGNATURE_DESC(
      const D3D12_ROOT_SIGNATURE_DESC& o) noexcept
  ...
  static void Init(
      _Out_ D3D12_ROOT_SIGNATURE_DESC& desc, UINT numParameters,
      _In_reads_opt_(numParameters) const D3D12_ROOT_PARAMETER* _pParameters,
      UINT numStaticSamplers = 0,
      _In_reads_opt_(numStaticSamplers)
          const D3D12_STATIC_SAMPLER_DESC* _pStaticSamplers = nullptr,
...
struct CD3DX12_ROOT_DESCRIPTOR_TABLE1 : public D3D12_ROOT_DESCRIPTOR_TABLE1 {
  ...
  explicit CD3DX12_ROOT_DESCRIPTOR_TABLE1(
      const D3D12_ROOT_DESCRIPTOR_TABLE1& o) noexcept
...
struct CD3DX12_ROOT_DESCRIPTOR1 : public D3D12_ROOT_DESCRIPTOR1 {
  ...
  static void Init(_Out_ D3D12_ROOT_DESCRIPTOR1& table, UINT shaderRegister,
                   UINT registerSpace = 0,
                   D3D12_ROOT_DESCRIPTOR_FLAGS flags =
                       D3D12_ROOT_DESCRIPTOR_FLAG_NONE) noexcept {
    table.ShaderRegister = shaderRegister;
...
struct CD3DX12_ROOT_PARAMETER1 : public D3D12_ROOT_PARAMETER1 {
  ...
  static void InitAsConstants(_Out_ D3D12_ROOT_PARAMETER1& rootParam,
                              UINT num32BitValues, UINT shaderRegister,
                              UINT registerSpace = 0,
                              D3D12_SHADER_VISIBILITY visibility =
                                  D3D12_SHADER_VISIBILITY_ALL) noexcept {
...
struct CD3DX12_VERSIONED_ROOT_SIGNATURE_DESC
  ...
  explicit CD3DX12_VERSIONED_ROOT_SIGNATURE_DESC(
      const D3D12_VERSIONED_ROOT_SIGNATURE_DESC& o) noexcept
  ...
  explicit CD3DX12_VERSIONED_ROOT_SIGNATURE_DESC(
      const D3D12_ROOT_SIGNATURE_DESC1& o) noexcept {
  ...
  void Init_1_0(UINT numParameters,
                _In_reads_opt_(numParameters)
                    const D3D12_ROOT_PARAMETER* _pParameters,
                UINT numStaticSamplers = 0,
                _In_reads_opt_(numStaticSamplers)
  ...
  static void Init_1_0(
      _Out_ D3D12_VERSIONED_ROOT_SIGNATURE_DESC& desc, UINT numParameters,
      _In_reads_opt_(numParameters) const D3D12_ROOT_PARAMETER* _pParameters,
      UINT numStaticSamplers = 0,
      _In_reads_opt_(numStaticSamplers)
          const D3D12_STATIC_SAMPLER_DESC* _pStaticSamplers = nullptr,
  ...
  void Init_1_1(UINT numParameters,
                _In_reads_opt_(numParameters)
...
struct CD3DX12_CPU_DESCRIPTOR_HANDLE : public D3D12_CPU_DESCRIPTOR_HANDLE {
  ...
  CD3DX12_CPU_DESCRIPTOR_HANDLE& Offset(INT offsetInDescriptors,
    ...
    ptr = static_cast<SIZE_T>(INT64(ptr) + INT64(offsetInDescriptors) *
  ...
  void InitOffsetted(_In_ const D3D12_CPU_DESCRIPTOR_HANDLE& base,
                     INT offsetScaledByIncrementSize) noexcept {
  ...
  auto operator==(const ComPtr<CD3DX12_CPU_DESCRIPTOR_HANDLE>& com);

  static void InitOffsetted(_Out_ D3D12_CPU_DESCRIPTOR_HANDLE& handle,
                            _In_ const D3D12_CPU_DESCRIPTOR_HANDLE& base,
                            INT offsetScaledByIncrementSize) noexcept {
    handle.ptr = static_cast<SIZE_T>(INT64(base.ptr) +
                                     INT64(offsetScaledByIncrementSize));
  }
...
struct CD3DX12_GPU_DESCRIPTOR_HANDLE : public D3D12_GPU_DESCRIPTOR_HANDLE {
  ...
  explicit CD3DX12_GPU_DESCRIPTOR_HANDLE(
      const D3D12_GPU_DESCRIPTOR_HANDLE& o) noexcept
  ...
  CD3DX12_GPU_DESCRIPTOR_HANDLE& Offset(INT offsetInDescriptors,
                                        UINT descriptorIncrementSize) noexcept {
    ptr = static_cast<UINT64>(INT64(ptr) + INT64(offsetInDescriptors) *
                                               INT64(descriptorIncrementSize));
    return *this;
  }
  ...
  bool operator==(
      _In_ const D3D12_GPU_DESCRIPTOR_HANDLE& other) const noexcept {
    return (ptr == other.ptr);
  }
  ...
  CD3DX12_GPU_DESCRIPTOR_HANDLE& operator=(
      const D3D12_GPU_DESCRIPTOR_HANDLE& other) noexcept {
    ptr = other.ptr;
    return *this;
  }

  void InitOffsetted(_In_ const D3D12_GPU_DESCRIPTOR_HANDLE& base,
                     INT offsetScaledByIncrementSize) noexcept {
    InitOffsetted(*this, base, offsetScaledByIncrementSize);
  }
  ...
  static void InitOffsetted(_Out_ D3D12_GPU_DESCRIPTOR_HANDLE& handle,
                            _In_ const D3D12_GPU_DESCRIPTOR_HANDLE& base,
                            INT offsetScaledByIncrementSize) noexcept {
    handle.ptr = static_cast<UINT64>(INT64(base.ptr) +
                                     INT64(offsetScaledByIncrementSize));
  }
...
//------------------------------------------------------------------------------------------------
constexpr UINT D3D12CalcSubresource(UINT MipSlice, UINT ArraySlice,
...
void D3D12DecomposeSubresource(UINT Subresource, UINT MipLevels, UINT ArraySize,
...
struct CD3DX12_RESOURCE_DESC : public D3D12_RESOURCE_DESC {
  ...
  static CD3DX12_RESOURCE_DESC Tex1D(
      DXGI_FORMAT format, UINT64 width, UINT16 arraySize = 1,
      UINT16 mipLevels = 0,
  ...
  static CD3DX12_RESOURCE_DESC Tex2D(
      DXGI_FORMAT format, UINT64 width, UINT height, UINT16 arraySize = 1,
  ...
  static CD3DX12_RESOURCE_DESC Tex3D(
      DXGI_FORMAT format, UINT64 width, UINT height, UINT16 depth,
      UINT16 mipLevels = 0,
      D3D12_RESOURCE_FLAGS flags = D3D12_RESOURCE_FLAG_NONE,
      D3D12_TEXTURE_LAYOUT layout = D3D12_TEXTURE_LAYOUT_UNKNOWN,
      UINT64 alignment = 0) noexcept {
  ...
  UINT CalcSubresource(UINT MipSlice, UINT ArraySlice,
                       UINT PlaneSlice) noexcept {
...
inline bool operator==(const D3D12_RESOURCE_DESC& l,
                       const D3D12_RESOURCE_DESC& r) noexcept {
...
struct CD3DX12_RESOURCE_DESC1 : public D3D12_RESOURCE_DESC1 {
  ...
  CD3DX12_RESOURCE_DESC1(D3D12_RESOURCE_DIMENSION dimension, UINT64 alignment,
                         UINT64 width, UINT height, UINT16 depthOrArraySize,
                         UINT16 mipLevels, DXGI_FORMAT format, UINT sampleCount,
                         UINT sampleQuality, D3D12_TEXTURE_LAYOUT layout,
                         D3D12_RESOURCE_FLAGS flags,
  ...
  static CD3DX12_RESOURCE_DESC1 Buffer(
      UINT64 width, D3D12_RESOURCE_FLAGS flags = D3D12_RESOURCE_FLAG_NONE,
      UINT64 alignment = 0) noexcept {
    return CD3DX12_RESOURCE_DESC1(D3D12_RESOURCE_DIMENSION_BUFFER, alignment,
                                  width, 1, 1, 1, DXGI_FORMAT_UNKNOWN, 1, 0,
                                  D3D12_TEXTURE_LAYOUT_ROW_MAJOR, flags, 0, 0,
                                  0);
  }
  ...
  static CD3DX12_RESOURCE_DESC1 Tex1D(
      ...
      D3D12_TEXTURE_LAYOUT layout = D3D12_TEXTURE_LAYOUT_UNKNOWN,
      UINT64 alignment = 0) noexcept {
    return CD3DX12_RESOURCE_DESC1(D3D12_RESOURCE_DIMENSION_TEXTURE1D, alignment,
                                  width, 1, arraySize, mipLevels, format, 1, 0,
                                  layout, flags, 0, 0, 0);
  }
  ...
  static CD3DX12_RESOURCE_DESC1 Tex3D(
      ...
      D3D12_TEXTURE_LAYOUT layout = D3D12_TEXTURE_LAYOUT_UNKNOWN,
      UINT64 alignment = 0) noexcept {
    return CD3DX12_RESOURCE_DESC1(D3D12_RESOURCE_DIMENSION_TEXTURE3D, alignment,
                                  width, height, depth, mipLevels, format, 1, 0,
                                  layout, flags, 0, 0, 0);
  }
...
inline bool operator==(const D3D12_RESOURCE_DESC1& l,
                       const D3D12_RESOURCE_DESC1& r) noexcept {
  return l.Dimension == r.Dimension && l.Alignment == r.Alignment &&
         l.Width == r.Width && l.Height == r.Height &&
         l.DepthOrArraySize == r.DepthOrArraySize &&
         l.MipLevels == r.MipLevels && l.Format == r.Format &&
         ...
         l.SamplerFeedbackMipRegion.Height ==
             r.SamplerFeedbackMipRegion.Height &&
...
struct CD3DX12_VIEW_INSTANCING_DESC : public D3D12_VIEW_INSTANCING_DESC {
  ...
  explicit CD3DX12_VIEW_INSTANCING_DESC(
      const D3D12_VIEW_INSTANCING_DESC& o) noexcept
...
inline void MemcpySubresource(_In_ const D3D12_MEMCPY_DEST* pDest,
  ...
  for (UINT z = 0; z < NumSlices; ++z) {
    ...
    auto pSrcSlice = static_cast<const BYTE*>(pSrc->pData) +
                     pSrc->SlicePitch * static_cast<LONG_PTR>(z);
...
inline void MemcpySubresource(_In_ const D3D12_MEMCPY_DEST* pDest,
  ...
  for (UINT z = 0; z < NumSlices; ++z) {
    auto pDestSlice = static_cast<BYTE*>(pDest->pData) + pDest->SlicePitch * z;
    auto pSrcSlice = (static_cast<const BYTE*>(pResourceData) + pSrc->Offset) +
                     pSrc->DepthPitch * static_cast<ULONG_PTR>(z);
    for (UINT y = 0; y < NumRows; ++y) {
      memcpy(pDestSlice + pDest->RowPitch * y,
...
inline UINT64 UpdateSubresources(
  ...
  for (UINT i = 0; i < NumSubresources; ++i) {
    ...
    D3D12_MEMCPY_DEST DestData = {
        ...
        static_cast<SIZE_T>(pLayouts[i].Footprint.RowPitch) *
            static_cast<SIZE_T>(pNumRows[i])};
    MemcpySubresource(&DestData, &pSrcData[i], pRowSizesInBytes[i], pNumRows[i],
...
inline UINT64 UpdateSubresources(
    ...
    _In_ const void* pResourceData,
    _In_reads_(NumSubresources)
        const D3D12_SUBRESOURCE_INFO* pSrcData) noexcept {
  // Minor validation
  auto IntermediateDesc = pIntermediate->GetDesc();
  auto DestinationDesc = pDestinationResource->GetDesc();
  if (IntermediateDesc.Dimension != D3D12_RESOURCE_DIMENSION_BUFFER ||
  ...
  for (UINT i = 0; i < NumSubresources; ++i) {
    ...
    D3D12_MEMCPY_DEST DestData = {
        ...
        static_cast<SIZE_T>(pLayouts[i].Footprint.RowPitch) *
            static_cast<SIZE_T>(pNumRows[i])};
    MemcpySubresource(&DestData, pResourceData, &pSrcData[i],
                      pRowSizesInBytes[i], pNumRows[i],
                      pLayouts[i].Footprint.Depth);
  }
  pIntermediate->Unmap(0, nullptr);
...
inline UINT64 UpdateSubresources(
    ...
    _In_reads_(NumSubresources)
        const D3D12_SUBRESOURCE_DATA* pSrcData) noexcept {
  UINT64 RequiredSize = 0;
  auto MemToAlloc = (sizeof(D3D12_PLACED_SUBRESOURCE_FOOTPRINT) + sizeof(UINT) +
                     sizeof(UINT64)) *
                    NumSubresources;
...
inline UINT64 UpdateSubresources(
  ...
  UINT64 Result = UpdateSubresources(
      pCmdList, pDestinationResource, pIntermediate, FirstSubresource,
      NumSubresources, RequiredSize, pLayouts, pNumRows, pRowSizesInBytes,
      pResourceData, pSrcData);
  HeapFree(GetProcessHeap(), 0, pMem);
  return Result;
}
...
UINT64 UpdateSubresources(_In_ ID3D12GraphicsCommandList* pCmdList,
                          ...
                          _In_ const void* pResourceData,
                          _In_reads_(NumSubresources)
                              D3D12_SUBRESOURCE_INFO* pSrcData) noexcept {
  UINT64 RequiredSize = 0;
  D3D12_PLACED_SUBRESOURCE_FOOTPRINT Layouts[MaxSubresources];
  UINT NumRows[MaxSubresources];
  UINT64 RowSizesInBytes[MaxSubresources];
  ...
  return UpdateSubresources(pCmdList, pDestinationResource, pIntermediate,
                            FirstSubresource, NumSubresources, RequiredSize,
                            Layouts, NumRows, RowSizesInBytes, pResourceData,
                            pSrcData);
}
...
ID3D12CommandList* const* CommandListCast(
    t_CommandListType* const* pp) noexcept {
      ...
      switch (pRootSignatureDesc->Version) {
        ...
        case D3D_ROOT_SIGNATURE_VERSION_1_1: {
          ...
          auto pParameters_1_0 =
              static_cast<D3D12_ROOT_PARAMETER*>(pParameters);
          ...
          if (pParameters) {
            for (UINT n = 0; n < desc_1_1.NumParameters; n++) {
              if (desc_1_1.pParameters[n].ParameterType ==
                ...
                HeapFree(
                    GetProcessHeap(), 0,
                    const_cast<D3D12_DESCRIPTOR_RANGE*>(pDescriptorRanges_1_0));
              }
            }
...
class alignas(void*) CD3DX12_PIPELINE_STATE_STREAM_SUBOBJECT {
 ...
 public:
  ...
  noexcept : _Type(Type), _Inner(i) { }

  CD3DX12_PIPELINE_STATE_STREAM_SUBOBJECT& operator=(
      const InnerStructType& i) noexcept {
    _Type = Type;
    _Inner = i;
    return *this;
  }
...
#pragma warning(pop)
using CD3DX12_PIPELINE_STATE_STREAM_FLAGS =
    CD3DX12_PIPELINE_STATE_STREAM_SUBOBJECT<
        D3D12_PIPELINE_STATE_FLAGS, D3D12_PIPELINE_STATE_SUBOBJECT_TYPE_FLAGS>;
using CD3DX12_PIPELINE_STATE_STREAM_NODE_MASK =
    CD3DX12_PIPELINE_STATE_STREAM_SUBOBJECT<
        UINT, D3D12_PIPELINE_STATE_SUBOBJECT_TYPE_NODE_MASK>;
using CD3DX12_PIPELINE_STATE_STREAM_ROOT_SIGNATURE =
    CD3DX12_PIPELINE_STATE_STREAM_SUBOBJECT<
        ID3D12RootSignature*,
        D3D12_PIPELINE_STATE_SUBOBJECT_TYPE_ROOT_SIGNATURE>;
using CD3DX12_PIPELINE_STATE_STREAM_INPUT_LAYOUT =
    CD3DX12_PIPELINE_STATE_STREAM_SUBOBJECT<
        D3D12_INPUT_LAYOUT_DESC,
        D3D12_PIPELINE_STATE_SUBOBJECT_TYPE_INPUT_LAYOUT>;
using CD3DX12_PIPELINE_STATE_STREAM_IB_STRIP_CUT_VALUE =
    CD3DX12_PIPELINE_STATE_STREAM_SUBOBJECT<
        D3D12_INDEX_BUFFER_STRIP_CUT_VALUE,
        D3D12_PIPELINE_STATE_SUBOBJECT_TYPE_IB_STRIP_CUT_VALUE>;
using CD3DX12_PIPELINE_STATE_STREAM_PRIMITIVE_TOPOLOGY =
    CD3DX12_PIPELINE_STATE_STREAM_SUBOBJECT<
        D3D12_PRIMITIVE_TOPOLOGY_TYPE,
        D3D12_PIPELINE_STATE_SUBOBJECT_TYPE_PRIMITIVE_TOPOLOGY>;
using CD3DX12_PIPELINE_STATE_STREAM_VS =
    CD3DX12_PIPELINE_STATE_STREAM_SUBOBJECT<
        D3D12_SHADER_BYTECODE, D3D12_PIPELINE_STATE_SUBOBJECT_TYPE_VS>;
using CD3DX12_PIPELINE_STATE_STREAM_GS =
    CD3DX12_PIPELINE_STATE_STREAM_SUBOBJECT<
        D3D12_SHADER_BYTECODE, D3D12_PIPELINE_STATE_SUBOBJECT_TYPE_GS>;
using CD3DX12_PIPELINE_STATE_STREAM_STREAM_OUTPUT =
    CD3DX12_PIPELINE_STATE_STREAM_SUBOBJECT<
        D3D12_STREAM_OUTPUT_DESC,
        D3D12_PIPELINE_STATE_SUBOBJECT_TYPE_STREAM_OUTPUT>;
using CD3DX12_PIPELINE_STATE_STREAM_HS =
    CD3DX12_PIPELINE_STATE_STREAM_SUBOBJECT<
        D3D12_SHADER_BYTECODE, D3D12_PIPELINE_STATE_SUBOBJECT_TYPE_HS>;
using CD3DX12_PIPELINE_STATE_STREAM_DS =
    CD3DX12_PIPELINE_STATE_STREAM_SUBOBJECT<
        D3D12_SHADER_BYTECODE, D3D12_PIPELINE_STATE_SUBOBJECT_TYPE_DS>;
using CD3DX12_PIPELINE_STATE_STREAM_PS =
    CD3DX12_PIPELINE_STATE_STREAM_SUBOBJECT<
...
// CD3DX12_PIPELINE_STATE_STREAM2 Works on OS Build 19041+ (where there is a new
// mesh shader pipeline). Use CD3DX12_PIPELINE_STATE_STREAM1 for OS Build 16299+
// (where there is a new view instancing subobject). Use
// CD3DX12_PIPELINE_STATE_STREAM for OS Build 15063+ support.
struct CD3DX12_PIPELINE_STATE_STREAM2 {
  CD3DX12_PIPELINE_STATE_STREAM2() = default;
  // Mesh and amplification shaders must be set manually, since they do not have
  // representation in D3D12_GRAPHICS_PIPELINE_STATE_DESC
...
// CD3DX12_PIPELINE_STATE_STREAM1 Works on OS Build 16299+ (where there is a new
// view instancing subobject). Use CD3DX12_PIPELINE_STATE_STREAM for OS Build
// 15063+ support.
...
// CD3DX12_PIPELINE_STATE_STREAM works on OS Build 15063+ but does not support
// new subobject(s) added in OS Build 16299+. See CD3DX12_PIPELINE_STATE_STREAM1
// for instance.
...
struct CD3DX12_PIPELINE_STATE_STREAM2_PARSE_HELPER
  ...
  void RasterizerStateCb(
      const D3D12_RASTERIZER_DESC& RasterizerState) override {
  ...
  for (SIZE_T CurOffset = 0, SizeOfSubobject = 0; CurOffset < Desc.SizeInBytes;
    ...
    switch (SubobjectType) {
      ...
      case D3D12_PIPELINE_STATE_SUBOBJECT_TYPE_AS:
        pCallbacks->ASCb(
            *reinterpret_cast<decltype(CD3DX12_PIPELINE_STATE_STREAM2::AS)*>(
                pStream));
        SizeOfSubobject = sizeof(CD3DX12_PIPELINE_STATE_STREAM2::AS);
        break;
      case D3D12_PIPELINE_STATE_SUBOBJECT_TYPE_MS:
        pCallbacks->MSCb(
            *reinterpret_cast<decltype(CD3DX12_PIPELINE_STATE_STREAM2::MS)*>(
                pStream));
...
//------------------------------------------------------------------------------------------------
inline bool operator==(const D3D12_CLEAR_VALUE& a,
                       const D3D12_CLEAR_VALUE& b) noexcept {
...
inline bool operator==(
    const D3D12_RENDER_PASS_BEGINNING_ACCESS_CLEAR_PARAMETERS& a,
    const D3D12_RENDER_PASS_BEGINNING_ACCESS_CLEAR_PARAMETERS& b) noexcept {
  return a.ClearValue == b.ClearValue;
}

inline bool operator==(
    const D3D12_RENDER_PASS_ENDING_ACCESS_RESOLVE_PARAMETERS& a,
...
inline bool operator==(const D3D12_RENDER_PASS_ENDING_ACCESS& a,
                       const D3D12_RENDER_PASS_ENDING_ACCESS& b) noexcept {
  if (a.Type != b.Type) return false;
...
class CD3DX12_STATE_OBJECT_DESC {
 ...
 private:
  ...
  using SUBOBJECT_WRAPPER =
      struct SUBOBJECT_WRAPPER : public D3D12_STATE_SUBOBJECT {
  ...
  std::list<D3D12_SUBOBJECT_TO_EXPORTS_ASSOCIATION>
      m_RepointedAssociations;  // subobject type that contains pointers to
                                // other subobjects,
  ...
  class OWNED_HELPER {
   public:
    OWNED_HELPER(const SUBOBJECT_HELPER_BASE* pHelper) noexcept {
      m_pHelper = pHelper;
    }
...
class CD3DX12_SUBOBJECT_TO_EXPORTS_ASSOCIATION_SUBOBJECT
 ...
 public:
  ...
  void SetSubobjectToAssociate(
      const D3D12_STATE_SUBOBJECT& SubobjectToAssociate) noexcept {
...
class CD3DX12_RAYTRACING_SHADER_CONFIG_SUBOBJECT
 ...
 public:
  ...
  void Config(UINT MaxPayloadSizeInBytes,
              UINT MaxAttributeSizeInBytes) noexcept {
...
class CD3DX12_RAYTRACING_PIPELINE_CONFIG1_SUBOBJECT
 ...
 public:
  ...
  void Config(UINT MaxTraceRecursionDepth,
              D3D12_RAYTRACING_PIPELINE_FLAGS Flags) noexcept {
    m_Desc.MaxTraceRecursionDepth = MaxTraceRecursionDepth;
    m_Desc.Flags = Flags;
  }
